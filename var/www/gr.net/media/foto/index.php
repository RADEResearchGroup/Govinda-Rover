<?php
	...
	require_once($_SERVER['DOCUMENT_ROOT'] . '/media/foto/foto.php');
...
<?php print display_print_page_wrapper_top();?>
	...
	<ul class="nav nav-tabs" role="tablist">
	  <li class="active"><a href="#"><?php print $text[82];?></a></li>
	  <li><a href="/media/video"><?php print $text[83];?></a></li>
	</ul>
	<div class="panel panel-default" style="margin-top:20px;">
	  <div class="panel-heading"><?php print $text[81];?></div>
